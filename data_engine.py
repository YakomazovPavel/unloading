...
templates = {
    'Температура': {
        ...
        'T max': (8, 4),
        'T раб': (9, 4),
        'Единицы измерения температуры': (9, 5),
        'P min': (10, 4),
        'P max': (11, 4),
        'P раб': (12, 4),
        ...
        'Тип сенсора': (17, 4),
        'Градуировка НСХ': (18, 4),
        'Одиночный / Спаренный или другой': (19, 4),
        'Диаметр ЧЭ': (20, 4),
        'Длина сенсора': (21, 4),
        'Соединение с процессом чувствительного элемента': (22, 4),
        'Число зон измерения (для многозонных)': (23, 4),
        'Температурная вставка (удлинитель)': (24, 4),
        'Шкала прибора': (25, 4),
        'Входной/выходной сигнал': (26, 4),
        'Напряжение питания': (27, 4),
        'Схема подключения (сигнал)': (28, 4),
        'Погрешность измерения': (29, 4),
        'Взрывозащита': (30, 4),
        'Уровень безопасности SIL': (31, 4),
        'Степень защиты': (32, 4),
        'Тип корпуса': (33, 4),
        'Материал корпуса': (34, 4),
        'Тип защитной гильзы': (35, 4),
        'Тип фланцев / резьбы': (36, 4),
        'DN фланцев': (37, 4),
        'PN фланцев': (38, 4),
        'Длина погружаемой части': (39, 4),
        'Маркировка защитной гильзы': (40, 4),
        'Местный индикатор': (41, 4),
        'Кабельный ввод': (42, 4),
        'Марка кабеля': (43, 4),
        'Обогрев': (44, 4),
        'Комплект монтажных частей': (45, 4),
        'Изготовитель': (46, 4),
        'Модель': (47, 4),
        'Примечание': (48, 4),
    },
    'Давление': {
        ...
        'Количество мембранных разделителей': (28, 4),
        'Тип фланцев': (29, 4),
        'DN фланцев': (30, 4),
        'PN фланцев': (31, 4),
        'Подвод импульсных трубок': (32, 4),
        'Вид мембранного разделителя': (33, 4),
        'Сторона высокого давления': (34, 4),
        'Тип вентильного блока': (35, 4),
        'Ниппель для присоединения импульсных линий': (36, 4),
        'Диаметр импульсной линии/капилляра': (37, 4),
        'Длина импульсной линии/капилляра выносной мембраны': (38, 4),
        'Промывочное кольцо': (39, 4),
        'Местный индикатор': (40, 4),
    ...
    'Расход': {
        ...
        'Шкала прибора': (22, 4),
        'Погрешность': (23, 4),
        'Входной/выходной сигнал': (24, 4),
        'Напряжение питания': (25, 4),
        'Схема подключения (сигнал)': (26, 4),
        'Местный индикатор': (27, 4),
        'Кабельный ввод (сигнал)': (28, 4),
        'Марка кабеля (сигнал)': (29, 4),
        'Взрывозащита': (30, 4),
        'Степень защиты': (31, 4),
        ...
        'Длина импульсной линии': (41, 4),
        'Обогрев': (42, 4),
        'Комплект монтажных частей': (43, 4),
        'Изготовитель': (44, 4),
        'Модель': (45, 4),
        'Примечание': (46, 4)
    },
    'Уровень': {
        ...
        'Выносная камера на аппарате': (6, 4),
        'Длина штуцера на аппарате': (7, 4),
        'Диаметр штуцера на аппарате': (8, 4),
        ...
        'Единицы измерения плотности верхней среды': (18, 5),
        'Вязкость верхней среды': (19, 4),
        'Вязкость нижней среды': (20, 4),
        'Единицы измерения вязкости верхней среды': (20, 5),
...
def getPressureForOL():
    ...
    df['Номер листа'] = df['index'] + 5 + shift_first_list
    df['Изменения'] = ''
    df_table_list_positions = df[['Изменения', 'index', 'Позиция', 'Номер схемы', 'Измеряемый параметр', 'Номер листа']].copy()
